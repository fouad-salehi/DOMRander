...
![DOMRander Browser Preview](PASTE_BROWSER_PREVIEW_IMAGE_URL_HERE)

### DOMRander Output

![DOMRander Output](PASTE_DOMRANDER_OUTPUT_IMAGE_URL_HERE)

The browser preview shows the original HTML and CSS rendered by the browser.

The DOMRander output shows the actual Canvas result generated by the renderer and exported from the playground.
